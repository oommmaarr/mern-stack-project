...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(#71C4FF44 0%)';
        ...
        >
          ...
          >
            ...
            >
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-[10px] border border-white/10 pointer-events-auto"
                  style={{
                    '--ui-inset': '20px',
                    '--ui-radius-bias': '6px',
                    bottom: 'var(--ui-inset)',
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: 'linear-gradient(to bottom, #fff, #00d4ff)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #ff00ff, #00ffff)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
